...
nombre_a_deviner = demander_saisie_nombre("Saisissez le nombre à deviner")
...
while True:
    ...
    victoire_jeu, nombre_minimum, nombre_maximum = jouer_un_coup(nombre_a_deviner, nombre_minimum, nombre_maximum)
