...
# PARTIE 1
nombre_minimum = nombre_maximum = 0
while True:
    nombre_minimum = demander_saisie_nombre("Quelle est la borne minimale ?")
    nombre_maximum = demander_saisie_nombre("Quelle est la borne maximale ?")
    if nombre_maximum > nombre_minimum:
        break

nombre = demander_saisie_nombre_borne("Saisissez le nombre à deviner", nombre_minimum, nombre_maximum)
...
while True:
    ...
    essai = demander_saisie_nombre_borne("Devinez le nombre", nombre_minimum, nombre_maximum)
